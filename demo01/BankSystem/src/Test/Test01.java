...
public class Test01 {
	public static void main(String[] args) {
		...
		long Upassword;
		//创建两个数组存储数据
		OrdinaryUser[] Ou=new OrdinaryUser[5];
		...
		Ou[3]=new OrdinaryUser("李雷", 200001L,200001L, 15000,true);
		Ou[4]=new OrdinaryUser("韩梅梅", 200002L,200002L, 100000,true);
							...
							case 4:
								...
								for(int j=0;j<Ou.length;j++){
									...
									if(Zou.getID()==Zid){
										...
										Uou.setMoney(Uou.getMoney()-Zmoney);
									}
								}
								b=0;
								break;
