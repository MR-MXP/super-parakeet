...
//		ArrayList<Person> list = new ArrayList<Person>();// 定义一个集合列表
		...
		people[0]=new Person("张三","女", 27, "中华人民共和国", false,"高中");
		people[1]=new Person("李克","男", 22, "中华人民共和国", false,"初中");
		people[2]=new Person("孙小清","女", 19, "加拿大", true,"本科");
		people[3]= new Person("王叶叶","女", 22, "中华人民共和国", false,"大专");
